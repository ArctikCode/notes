...
if($count !== 1){
    echo '<div class="alert alert-danger">The identification went wrong. Try again.</div>';
}
else {
    ...
    $_SESSION['email']=$row['email'];
       ...
       if(empty($_POST['rememberMe'])){
        ...
        //Store them in a cookie  the two variables are creating complexity for secutity reason
        function f1($a, $b){
            $c = $a . "," . bin2hex($b);
            return $c;
        }
